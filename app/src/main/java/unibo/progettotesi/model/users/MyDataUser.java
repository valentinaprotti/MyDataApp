...
import unibo.progettotesi.model.MyData.IPersonalDataVault;
import unibo.progettotesi.model.MyData.PersonalDataVault;
 ...
 * operations.
 *
 * Each MyData user may have one account for each GoBoBusService. Accounts can't be
